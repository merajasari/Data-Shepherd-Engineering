    ...
    def test_v5_dashboard_reads_decisions_and_realizations_without_mutation(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            manifest.write_text(json.dumps({
                "preregistered_start_utc": "2026-09-22T07:00:00+00:00",
                "first_eligible_decision_utc": "2026-09-23T00:00:00+00:00",
            }))
            ...
            events = [
                {"event_type": "DECISION", "decision_timestamp_utc": "2026-09-23T00:00:00Z",
                ...
                {"event_type": "REALIZATION", "decision_timestamp_utc": "2026-09-23T00:00:00Z",
                 "realized_through_utc": "2026-09-26T00:00:00Z", "selected_regime": "RISK_ON",
