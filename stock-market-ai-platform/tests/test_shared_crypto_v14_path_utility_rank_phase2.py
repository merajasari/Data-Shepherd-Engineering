...
from ml.shared_crypto_v14_path_utility_rank import phase2


class SharedCryptoV14Phase2Test(unittest.TestCase):
    ...
    def test_model_is_exact_preregistered_hgb_regressor(self):
    ...
    def test_daily_ranking_metrics_reward_correct_ranking(self):
        products = [
    ...
    def test_fold_metrics_preserve_ic_and_top3_excess(self):
        daily = pd.DataFrame({
            "spearman_ic": [
                0.10,
                0.20,
    ...
    def test_contract_validation_rejects_model_drift(self):
        contract = {
            "research_version": phase2.RESEARCH_VERSION,
            "future_holdout_start_utc": phase2.HOLDOUT.isoformat(),
            "target": {
                "primary": phase2.TARGET,
                "primary_round_trip_cost_bps": 25.0,
            },
            "model": {
                "primary": phase2.PRIMARY_MODEL,
                "learning_rate": 0.05,
                "max_iter": 201,
                "max_leaf_nodes": 15,
                "max_depth": None,
