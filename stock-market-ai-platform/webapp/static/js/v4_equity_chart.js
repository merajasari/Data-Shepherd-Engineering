(() => {
  ...
  style.textContent = `
    ...
    .smc-workspace{display:grid;grid-template-columns:minmax(270px,330px) minmax(0,1fr);gap:16px;align-items:start;margin-top:14px}.smc-sidebar{min-width:0;padding:12px;border:1px solid rgba(120,155,205,.16);border-radius:16px;background:rgba(7,16,31,.4)}.smc-sidebar>#smc-load-status{display:inline-flex;margin-bottom:10px}.smc-sidebar .smc-metrics{grid-template-columns:1fr 1fr;gap:8px;margin:0}.smc-sidebar .metric{padding:10px 11px;min-width:0}.smc-sidebar .metric span{font-size:.61rem}.smc-sidebar .metric strong{font-size:.98rem;margin-top:4px;overflow-wrap:anywhere}.smc-sidebar .smc-toolbar{gap:6px;margin:10px 0 0}.smc-sidebar .smc-toolbar>.muted{width:100%;font-size:.64rem;letter-spacing:.08em}.smc-sidebar .smc-toolbar>.muted[style]{margin-left:0!important;margin-top:3px}.smc-sidebar .smc-btn{padding:6px 9px;font-size:.69rem}.smc-sidebar .smc-range-message{min-height:0;margin:8px 0 4px;font-size:.7rem}.smc-sidebar .smc-models{display:grid;grid-template-columns:1fr;gap:6px;margin:7px 0}.smc-sidebar .smc-models>.muted{font-size:.64rem;letter-spacing:.08em}.smc-sidebar .smc-model{width:100%;display:grid;grid-template-columns:10px minmax(0,1fr);gap:4px 8px;text-align:left;padding:7px 9px;font-size:.74rem}.smc-sidebar .smc-model-value{grid-column:2;font-size:.66rem;line-height:1.25}.smc-sidebar .smc-ux{padding:9px;margin:9px 0 0;gap:6px}.smc-sidebar .smc-ux .hint{width:100%;font-size:.69rem;line-height:1.35}.smc-sidebar .smc-nav{padding:6px 8px;font-size:.66rem}.smc-sidebar .smc-zoom-status{padding:6px 8px;font-size:.65rem}.smc-workspace>.smc-panel{margin:0}.smc-workspace .smc-svg{height:560px}
