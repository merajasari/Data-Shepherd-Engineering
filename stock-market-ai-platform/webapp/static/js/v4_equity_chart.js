(() => {
  ...
  card.innerHTML = `
    ...
    <div id="smc-method-note" class="smc-warning">V6 and V7 are intentionally excluded. V8 and V10 lines are development-era reconstructions. Frozen V8 has separate genuine forward evidence; V10 failed one required gate, was not frozen, and has no activated November holdout.</div>
