(() => {
  ...
  card.innerHTML = `
    <div class="smc-head"><div><div class="label">MODEL PERFORMANCE COMPARISON</div><div class="smc-title">V4 vs V5 vs frozen V8 vs reconstructed V10 vs SPY</div><div class="smc-subtitle">Every strategy is shown on the same hypothetical $100,000 basis. Live paper-account balances are intentionally excluded, so there is no artificial reset or vertical drop when reconstructed history reaches the present.</div></div><span id="smc-load-status" class="mode">LOADING MODELS</span></div>
    ...
    <div id="smc-method-note" class="smc-warning">V6 and V7 are intentionally excluded. V8 and the displayed V10 line are development-era reconstructions. Frozen V8 has separate genuine forward evidence. Original V10 and Cycle 2 were rejected for the November holdout; the separately preregistered Cycle 3 candidate is frozen for a fresh holdout beginning January 4, 2027 and has no forward results yet.</div>
