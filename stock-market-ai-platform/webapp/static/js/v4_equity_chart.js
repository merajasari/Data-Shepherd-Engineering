(() => {
  ...
  card.innerHTML = `
    ...
    <div class="smc-panel"><svg id="smc-chart" class="smc-svg" viewBox="0 0 1200 520" preserveAspectRatio="none"></svg><div id="smc-tooltip" class="smc-tooltip"></div><div id="smc-scale-note" class="smc-note">Common-overlap growth index: every active line is rebased to 100 at the beginning of the shared eligible window. V11 begins in May 2026 because no earlier five-minute development history was backfilled.</div></div>
  ...
  function render(){
    ...
    set('smc-scale-note',mode==='normalized'?'Common-overlap growth index: every active line is rebased to 100 at the beginning of the shared eligible window. V11 begins in May 2026 because no earlier five-minute development history was backfilled.':'Equity USD preserves each model’s full eligible compounded history; late-starting V11 begins at $100,000 in May 2026.');
