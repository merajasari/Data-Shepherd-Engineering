(() => {
  ...
  style.textContent = `
    ...
    .smc-metrics{display:grid;grid-template-columns:repeat(5,1fr);gap:12px;margin:16px 0}.smc-toolbar{display:flex;gap:10px;align-items:center;flex-wrap:wrap;margin:14px 0}.smc-btn{padding:9px 13px;border-radius:999px;border:1px solid var(--border);background:var(--panel);color:var(--muted);font-weight:850;cursor:pointer}.smc-btn:hover,.smc-btn.active{color:#06151d;background:linear-gradient(90deg,var(--cyan),var(--green));border-color:transparent}
