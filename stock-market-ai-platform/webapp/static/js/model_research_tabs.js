(() => {
  ...
  const MODELS = [
    ...
    {id:'v13', label:'V13 Dev', eyebrow:'V13 · PREREGISTERED DEVELOPMENT · NOT FROZEN', title:'V13 regime-overlay research', note:'V13 is a preregistered successor hypothesis with activation disabled. Its retrospective curve remains on Overview and never counts as fresh evidence.'}
  ];
