...
def validate_artifact():
    ...
    require(
        payload.get("excluded_models") == ["V6", "V7", "V11"],
        "V6/V7/V11 exclusion changed",
    )
...
def validate_dashboard_source():
    ...
    required = [
        ...
        "V4 vs V5 vs frozen V8 vs frozen V10 Cycle 3 vs SPY",
        "V6, V7, and V11 are intentionally excluded from this model-history chart",
