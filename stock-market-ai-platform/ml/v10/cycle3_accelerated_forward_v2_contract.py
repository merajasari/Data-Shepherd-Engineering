"""Identity and validation for the clean V10 Cycle 3 V2 paper-forward lane.
...
FIRST_DECISION_SESSION_UTC = "2026-09-10T00:00:00+00:00"
...
def validate_contract(contract: Mapping[str, object]) -> tuple[str, ...]:
    reasons: list[str] = []
    if contract.get("contract_id") != "V10_CYCLE3_ACCELERATED_PAPER_FORWARD_V2":
