"""Clean V2 prospective paper-forward runner for V10 Cycle 3 evidence.

Only predictions locked after a completed session and before the next market
open are eligible. Missed decisions are never backfilled. The V2 lane starts clean on September 10, 2026, is isolated from V1 and the original January holdout, and has no brokerage interface.
"""
...
JOURNAL_TYPE = "V10_CYCLE3_ACCELERATED_PROSPECTIVE_PAPER_FORWARD_V2"
