"""Shared Crypto V2 Clean Forward V3 isolated paper-evaluation entrypoint.

V3 reuses the unchanged frozen Phase 5 HGB artifact and confirm-2 policy while
placing every stateful output in a new lane. Clean Forward V2 is the immutable
interrupted parent and is never resumed or backfilled.

Preregistered boundary: 2026-09-22 07:00 UTC (midnight America/Los_Angeles).
...
PARENT_ROOT = PHASE5_ROOT / "clean_forward_v2"
CLEAN_ROOT = PHASE5_ROOT / "clean_forward_v3"
CLEAN_START = pd.Timestamp("2026-09-22T07:00:00Z")
CLEAN_LANE_ID = "shared_crypto_v2_clean_forward_v3"
CLEAN_LANE_NAME = "Shared Crypto V2 Clean Forward V3"


def configure() -> None:
    """Point the proven service implementation at the isolated V3 contract."""
    ...
    # The interrupted V2 lane is the immutable parent for V3.
