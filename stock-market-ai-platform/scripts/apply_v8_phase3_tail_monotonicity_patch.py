"""Apply Stock V8 Phase 3 tail/monotonicity diagnostics."""

from pathlib import Path

PHASE3 = Path("ml/v8/phase3.py")


def main():
    PHASE3.parent.mkdir(parents=True, exist_ok=True)
    PHASE3.write_text(r'''"""Stock V8 Phase 3: cross-sectional tail and monotonicity diagnostics.
...
''', encoding="utf-8")
    ...
    print("[APPLY] ml/v8/phase3.py")
    print()
    print("Stock V8 Phase 3 tail/monotonicity patch complete.")
    print("Deciles, fixed Top-5/10/20 diagnostics, persistence, concentration, and pairwise ranks only.")
    print("Sector concentration is explicitly marked unavailable rather than fabricated when sector metadata is absent.")
    print("The 2026-09-01+ holdout remains sealed. No fitting, selection, portfolio simulation, freeze, or orders.")
