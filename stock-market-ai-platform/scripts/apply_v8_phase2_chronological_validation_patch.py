"""Apply Stock V8 Phase 2 chronological orthogonal-signal validation."""

from pathlib import Path

PHASE2 = Path("ml/v8/phase2.py")


def main():
    PHASE2.parent.mkdir(parents=True, exist_ok=True)
    PHASE2.write_text(r'''"""Stock V8 Phase 2: chronological validation of three fixed orthogonal signals.
...
''', encoding="utf-8")
    ...
    print(f"[APPLY] {PHASE2}")
    print()
    print("Stock V8 Phase 2 chronological-validation patch complete.")
    print("Three fixed Phase-1 signals only; volatility/beta neutralization unchanged.")
    print("The 2026-09-01+ holdout remains sealed. No fitting, combination, portfolio simulation, freeze, or orders.")
