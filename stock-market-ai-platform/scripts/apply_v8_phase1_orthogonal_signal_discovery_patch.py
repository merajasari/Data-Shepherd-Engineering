"""Apply Stock V8 Phase 1 orthogonal signal discovery diagnostics."""

from pathlib import Path

FILES = {
    Path("ml/v8/__init__.py"): '''"""Stock V8 research track."""\nRESEARCH_VERSION = "v8"\n''',
    Path("ml/v8/config.py"): '''from __future__ import annotations\n\nimport pandas as pd\n\nRESEARCH_VERSION = "v8"\nFUTURE_HOLDOUT_START_UTC = pd.Timestamp("2026-09-01T00:00:00Z")\nBENCHMARK_SYMBOL = "SPY"\nTARGET_HORIZON_SESSIONS = 5\n''',
}

PHASE1 = Path("ml/v8/phase1.py")
...
def main():
    ...
    PHASE1.write_text(r'''"""Stock V8 Phase 1: volatility/beta-orthogonal signal discovery.
...
if __name__ == "__main__":
    main()
''', encoding="utf-8")
    print(f"[APPLY] {PHASE1}")
    print()
    print("Stock V8 Phase 1 orthogonal-signal discovery patch complete.")
    print("New research track: simple signals neutralized to volatility and SPY beta.")
    print("The 2026-09-01+ V8 holdout remains sealed. No fitting, selection, portfolio simulation, freeze, or orders.")
