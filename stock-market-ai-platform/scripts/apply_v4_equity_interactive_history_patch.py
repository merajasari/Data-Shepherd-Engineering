...
CONTENT = r'''(() => {
  ...
  function render() {
    ...
    const overlay=node('rect',{x:p.l,y:p.t,width:W-p.l-p.r,height:H-p.t-p.b,fill:'transparent',style:'cursor:crosshair;touch-action:none'});
...
print("[APPLY] V4 portfolio equity chart upgraded to Interactive Market History behavior")
print("V4 equity interaction patch complete.")
print("Vertical guide, moving time/equity tags, tooltip, slider, and selected-observation readouts are enabled.")
print("Presentation only; V4 portfolio state, journals, frozen models, and brokerage settings are unchanged.")
